    ...
    <div class="main-container">
        <div class="xs-pd-20-10 pd-ltr-20">
                ...
                <div class="col-lg-4 col-md-12 mb-20">
                    <div class="card-box height-100-p pd-20 min-height-200px">
                        <div class="max-width-300 mx-auto">
                            <img src="{{ asset('asset/admin/vendors/images/upgrade.svg') }}" alt="" />
                        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('asset/admin/vendors/images/photo5.jpg') }}"
                                            class="border-radius-100 shadow" width="40" height="40"
                                            alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('asset/admin/vendors/images/photo6.jpg') }}"
                                            class="border-radius-100 shadow" width="40" height="40"
                                            alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('asset/admin/vendors/images/photo9.jpg') }}"
                                            class="border-radius-100 shadow" width="40" height="40"
                                            alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('asset/admin/vendors/images/photo8.jpg') }}"
                                            class="border-radius-100 shadow" width="40" height="40"
                                            alt="" />
                                    </div>
                                    <div class="txt">
            ...
            <div class="row">
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('asset/admin/vendors/images/medicine-bro.svg') }}" alt="" />
                        </div>
                        <div class="content">
                ...
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('asset/admin/vendors/images/remedy-amico.svg') }}" alt="" />
                        </div>
                        <div class="content">
                ...
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('asset/admin/vendors/images/paper-map-cuate.svg') }}" alt="" />
                        </div>
                        <div class="content">
            ...
            <div class="footer-wrap pd-20 mb-20 card-box">
                <a href="https://github.com/dropways" target="_blank">Phong NT</a>
            </div>
        </div>
