...
<div class="why-choose-section">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-lg-5">
                <div class="img-wrap">
                    <img src="{{ asset('asset/client/images/why-choose-us-img.jpg') }}" alt="Image" class="img-fluid">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                <img src="{{ asset('asset/client/images/person_1.jpg') }}" class="img-fluid mb-5">
            ...
            <!-- Start Column 2 -->
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                <img src="{{ asset('asset/client/images/person_2.jpg') }}" class="img-fluid mb-5">
            ...
            <!-- Start Column 3 -->
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                <img src="{{ asset('asset/client/images/person_3.jpg') }}" class="img-fluid mb-5">
            ...
            <!-- Start Column 4 -->
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                <img src="{{ asset('asset/client/images/person_4.jpg') }}" class="img-fluid mb-5">
                                    ...
                                    <div class="testimonial-block text-center">
                                        ...
                                        <div class="author-info">
                                            <div class="author-pic">
                                                <img src="{{ asset('asset/client/images/person-1.png')}}" alt="Maria Jones" class="img-fluid">
                                            </div>
